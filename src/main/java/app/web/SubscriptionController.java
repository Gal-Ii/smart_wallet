...
public class SubscriptionController {
    ...
    @PostMapping
    public ModelAndView upgrade(@Valid UpgradeRequest upgradeRequest, BindingResult bindingResult, HttpSession session, @RequestParam SubscriptionType subscriptionType) {
        UUID userId = (UUID) session.getAttribute("userId");
        User user = userService.getById(userId);
